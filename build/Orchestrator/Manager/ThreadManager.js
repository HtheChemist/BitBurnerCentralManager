...
import { DEBUG, HACKING_SCRIPTS, HACKING_SERVER, } from "/Orchestrator/Config/Config";
...
export async function main(ns) {
    ...
    async function addHost(message) {
        ...
        if (host === HACKING_SERVER)
            return;
        const hostThreads = Math.floor(ns.getServerMaxRam(host) / ramChunk);
